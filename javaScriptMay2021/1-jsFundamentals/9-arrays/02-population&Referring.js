...
//console.log(students instanceof Array); //instanceof tell me my array is an array
...
// food = food.slice(2,5); //the first number is the first element to slice from an array, while the 
